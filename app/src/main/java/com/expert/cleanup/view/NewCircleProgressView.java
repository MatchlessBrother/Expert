...
public class NewCircleProgressView  extends View
{
    ...
    private CircleProgressView.CircleProgressUpdateListener updateListener;
    ...
    public NewCircleProgressView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
    ...
    public NewCircleProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(){
        ...
        tractPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        tractPaint.setStyle(Paint.Style.STROKE);
        tractPaint.setStrokeCap(Paint.Cap.ROUND);
        tractPaint.setStrokeWidth(mTrackWidth);
    ...
    private void drawTrack(Canvas canvas){
        if(trackEnabled){
            tractPaint.setShader(null);
            tractPaint.setColor(mTrackColor);
            if(fillEnabled) {
                tractPaint.setStyle(Paint.Style.FILL);
    ...
    private void initTrack(Canvas canvas, boolean isFilled){
        if(circleBroken){
            canvas.drawArc(mOval, 135, 270, isFilled, tractPaint);
        }else {
            canvas.drawArc(mOval, 90, 360, isFilled, tractPaint);
        }
    }
    ...
    public void setTrackWidth(int width){
        ...
        tractPaint.setStrokeWidth(width);
        updateTheTrack();
        refreshTheView();
    }
    ...
    public void startProgressAnimation(){
        ...
        progressAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if(updateListener != null){
                    updateListener.onCircleProgressUpdate(NewCircleProgressView.this, progress);
                }
        ...
        progressAnimator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationStart(Animator animator) {
                if(updateListener != null){
                    updateListener.onCircleProgressStart(NewCircleProgressView.this);
                }
            }
            ...
            public void onAnimationEnd(Animator animator) {
                if(updateListener != null){
                    updateListener.onCircleProgressFinished(NewCircleProgressView.this);
                }
            }
     ...
     */
    public void setProgressViewUpdateListener(CircleProgressView.CircleProgressUpdateListener listener){
